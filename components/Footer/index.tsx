...
export const Footer = () => {
  return (
    <footer className="w-full hidden lg:block bg-white fixed bottom-0">
      <div className="mx-auto p-4 flex items-center justify-between">
        <div className="text-xs flex-none  text-gray-500">
          Made by Substrait • Get more from your music.
        </div>

        {/* Navigation */}
        <div className="flex-grow absolute left-0 w-full">
          <nav className="flex justify-center items-center">
            ...
            <Link className="mx-6" href="/privacy">
              Privacy
            </Link>
          </nav>
        </div>
        ...
        {/* Socials */}
        <ul className="flex flex-row justify-between flex-none">
          <li className="ml-3">
            <Link href="https://instagram.com/substrait">
              <svg
